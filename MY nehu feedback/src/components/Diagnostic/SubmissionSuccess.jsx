export function SubmissionSuccess({ name, onReset, onViewAnalytics }) {
  return (
    <div style={{ textAlign: 'center', padding: '2.5rem 1rem' }}>
      <h2 className="font-heading" style={{ color: 'var(--emerald-neon)', fontSize: '1.5rem', marginBottom: '0.8rem' }}>FEEDBACK RECORDED!</h2>
      <p style={{ color: 'var(--text-muted)', marginBottom: '1.8rem', fontSize: '0.95rem' }}>Thank you <strong style={{ color: '#fff' }}>{name}</strong>! Your response has been submitted successfully.</p>
